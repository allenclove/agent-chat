...
const ChatRender = {
  ...
  addMessage(msg, container, autoScroll, currentUser) {
    ...
    const bubbleClass = isSelf
      ? 'msg-bubble msg-bubble-self bg-purple-500 text-white rounded-2xl rounded-tr-sm px-4 py-2 pr-6'
      : senderType === 'agent'
        ? 'msg-bubble msg-bubble-other bg-gradient-to-r from-purple-50 to-indigo-50 text-gray-800 rounded-2xl rounded-tl-sm px-4 py-2 pr-6 border border-purple-200'
        : 'msg-bubble msg-bubble-other bg-gray-100 text-gray-800 rounded-2xl rounded-tl-sm px-4 py-2 pr-6';
